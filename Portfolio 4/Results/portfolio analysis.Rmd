...
p1 <- ggplot(base_long, aes(x = year, y = share_belief, color = gender)) + 
  geom_point() + 
  theme_minimal() +
  xlab("Year") + 
  ylab("Share of population holding a status belief favoring each gender") +
  ylim(0,1) +
  facet_wrap(~ run) + 
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank())

ggsave("hypothesis1.png")
```
...
#ggsave("baseline.png") 
# Run number 14 was excluded from further analysis
...
p1 <- ggplot(int1_long, aes(x = year, y = share_belief, color = gender)) + 
  geom_point() + 
  theme_minimal() +
  xlab("Year") + 
  ylab("Share of population holding a status belief favoring each gender") +
...
p1 <- ggplot(int2_long, aes(x = year, y = share_belief, color = gender)) + 
  geom_point() + 
  theme_minimal() +
  xlab("Year") + 
  ylab("Share of population holding a status belief favoring each gender") +
...
# exclude run no 60 from further analysis
...
p1 <- ggplot(int3_long, aes(x = year, y = share_belief, color = gender)) + 
  geom_point() + 
  theme_minimal() +
  xlab("Year") + 
  ylab("Share of population holding a status belief favoring each gender") +
...
# Run number 68 was excluded from further analysis
...
p1 <- ggplot(int4_long, aes(x = year, y = share_belief, color = gender)) + 
  geom_point() + 
  theme_minimal() +
  xlab("Year") + 
  ylab("Share of population holding a status belief favoring each gender") +
...
p1 <- ggplot(int5_long, aes(x = year, y = share_belief, color = gender)) + 
  geom_point() + 
  theme_minimal() +
  xlab("Year") + 
  ylab("Share of population holding a status belief favoring each gender") +
